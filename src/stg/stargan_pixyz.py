...
class StarGAN(Model):
    ...
    def __init__(self, p_data, generator, c, image_dir, mode, discriminator={}, image_size=256, batch_size=16, c_dim=8, resume_iters=None, model_save_dir=None):
        ...
        self.out_parent_dir = "C:/Users/Ichiyama/Documents/GitHub/facialexp_conv"
...
if __name__ == '__main__':
    ...
    # # set model
    # model = StarGAN(p_data, G, c, D, image_dir, c_dim=c_dim, image_size=image_size, resume_iters=None)
